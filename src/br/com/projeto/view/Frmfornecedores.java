...
public class Frmfornecedores extends javax.swing.JFrame {
    ...
    private void tabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
        ...
        cnpj.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),2).toString());
        email.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),3).toString());
        telefone.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),4).toString());
        celular.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),5).toString());
        cep.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),6).toString());
        endereco.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),7).toString());
        ...
        cidade.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),11).toString());
        comboBoxUF.setSelectedItem(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(),12).toString());
    ...
    private void btnpesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpesquisarActionPerformed
        ...
        List<Fornecedores> lista = dao.listarFornecedorPorNome(nome);
